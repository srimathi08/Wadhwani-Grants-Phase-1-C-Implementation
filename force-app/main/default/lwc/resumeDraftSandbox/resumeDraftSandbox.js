    ...
    getStateParameters(currentPageReference) {
        ...
        @track applicationData = {
           ...
           // Project_End_Date__c: '',
            ...
            Competitive_Landscape__c: '', //changed Competitive_Landscape__c Competitive_Advantage__c
            ...
            Potential_for_Commercialization__c: '', //Potential_for_Commercialization__c  Plan_for_Commercialization__c
...
validateMonthYear(event) {
    ...
    if (budgetToDelete?.Id) {
        ...
        handleMilestoneChange(event) {
            ...
            // Handle new text-based dates
         if (field === "Project_Start_Date__c" || field === "Project_End_Date__c") {
              this.milestones = this.milestones.map(m =>
             m.uniqueId === uniqueId ? { ...m, [field]: value } : m
            );
            return;
       }
        ...
        restoreEditorContent() {
            ...
            const richTextFields = [
               ...
               "Novelty_of_the_Project__c",
                ...
                "Target_Market_Industry_Application__c",
                "Customer_and_Beneficiaries__c",
                "Potential_for_Commercialization__c", // Plan_for_Commercialization__c Potential_for_Commercialization__c
                "Business_Model_for_Commercialization__c",  
...
get sanitizedBudgets() {
               ...
               // const pageToUse = this.isPreviewVisible ? this.previewPage : this.currentPage;
                const pageFields = {
                    ...
                    3: [
                        ...
                        "Current_status_of_the_Project_Work_und__c",
                        "Project_Approach_and_Work_Plan__c",
                        "Competitive_Landscape__c", //Competitive_Landscape__c Competitive_Advantage__c
                        "Details_of_IPR_Filed_Granted__c",
                        "Details_of_Ethical_Received__c",
                         "Full_Proposal_Citations__c"               
                    ],
    ...
    get formattedCompetitiveLandscape() {
        return this.cleanRichText(this.applicationData.Competitive_Landscape__c); //Competitive_Landscape__c Competitive_Advantage__c
    }
   ...
   /* Production code
    ...
    const draftMilestones = this.milestones
        ...
        .map(m => {
            ...
            // Normalize dates converted as Text
           /* if (clean.Project_Start_Date__c) {
            ...
            //new lines
            // Dynamic Installment mapping based on row number
/*const fieldName = `Installment_of_Funds_${m.uniqueId}__c`;
clean[fieldName] = m.InstallmentLabel;*/
