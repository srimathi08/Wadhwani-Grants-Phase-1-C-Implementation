...
import saveApplicationReview from '@salesforce/apex/WCF_ReviewFormBothController.saveApplicationReview';
import getIndividualApplication from '@salesforce/apex/WCF_ReviewFormBothController.getIndividualApplication';
import hasAlreadyReviewed from '@salesforce/apex/WCF_ReviewFormBothController.hasAlreadyReviewed';
import getDraftReviewRecord from '@salesforce/apex/WCF_ReviewFormBothController.getDraftReviewRecord';
import saveDraftReview from '@salesforce/apex/WCF_ReviewFormBothController.saveDraftReview';



export default class wcfBothReviewerForm extends (LightningElement) {
   //@api recordId;
   @track recordId;
    logoUrl = WIN_LOGO;
   ...
   // @track isLoading = true;
    @track reviewData = {
               ...
               Top_3_proposal_strengths_ranked__c: '',
               Top_3_proposal_weaknesses_ranked__c:'',
               Business_Creation_Growth_Effectiveness__c: '',
