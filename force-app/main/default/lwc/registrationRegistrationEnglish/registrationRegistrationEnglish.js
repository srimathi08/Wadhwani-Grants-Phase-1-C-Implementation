...
import { OMNIDEF } from './registrationRegistrationEnglish_def.js';
import tmpl from './registrationRegistrationEnglish.html';
import tmpl_nds from './registrationRegistrationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class registrationRegistrationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
