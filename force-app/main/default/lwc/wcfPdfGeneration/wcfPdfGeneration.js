    ...
    ['Balance at End of Year', fmtCurrency(hist.CY1_Balance_End__c), fmtCurrency(hist.CY2_Balance_End__c), fmtCurrency(hist.CY3_Balance_End__c)]
        ...
        if (fy) {
            ...
            doc.autoTable({
                ...
                body: [
    ['Revenue', fmtCurrency(fy.Revenue_Budget__c), fmtCurrency(fy.Revenue_Projection__c), fmtCurrency(fy.Revenue_Variance__c), parseHtmlToText(fy.Revenue_Explanation__c)],
    ['Expense', fmtCurrency(fy.Expense_Budget__c), fmtCurrency(fy.Expense_Projection__c), fmtCurrency(fy.Expense_Variance__c), parseHtmlToText(fy.Expense_Explanation__c)],
    ['Revenue - Expense', fmtCurrency(fy.Net_Budget__c), fmtCurrency(fy.Net_Projection__c), fmtCurrency(fy.Net_Variance__c), parseHtmlToText(fy.Net_Position_Explanation__c)]
],
                theme: 'grid',
                styles: { fontSize: 10 },
                headStyles: { fillColor: [191, 32, 38], textColor: 255 }
